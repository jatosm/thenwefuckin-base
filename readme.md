...
**WORLD**
- Enable World + Name / Distance
- Ores (Stone / Phosphate / Metal)
...
- Menu Font Size
- ESP Font Size
- Slider value boxes (click a number to type the exact value)
- Custom skybox IDs
- Custom Theme + Reset
- Config System (Save / Load / Export / Import as .config)
