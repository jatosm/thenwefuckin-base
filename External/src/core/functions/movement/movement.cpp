...
void TickFly(bool& gravOver, float& gravBackup) {
    ...
    bool block_input = variables::Movement::flyCheckTyping && chat_focused;
    bool allow_toggle = roblox_active && !chat_focused;
    ...
    else if (chat_focused && variables::Movement::flyKey) ::GetAsyncKeyState(variables::Movement::flyKey);
    ...
    bool allow_move = roblox_active && !block_input;
