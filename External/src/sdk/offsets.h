...
inline constexpr uintptr_t SetParent = 0xEC0090;
...
inline constexpr uintptr_t AnchorPoint = 0x54C;
...
inline constexpr uintptr_t CreatorTable = 0x61CE910;
inline constexpr uintptr_t EntryValue = 0x8;
inline constexpr uintptr_t NameRegistry = 0x80E2C90;
...
inline constexpr uintptr_t TextScaled = 0xB81;
